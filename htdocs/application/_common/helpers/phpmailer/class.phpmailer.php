...
class PHPMailer {
   ...
   * @var string
   */
  public $ContentType       = 'text/html';//'text/plain';
   ...
   * @var string
   */
  public $From              = 'info@solicitaxi.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'solicitaxi';
   ...
   * @var string
   */
  public $Sender            = 'info@solicitaxi.com';
   ...
   * @var string
   */
  public $Host        = 'mail.solicitaxi.com';
   ...
   * @var string
   */
  public $Username     = 'info@solicitaxi.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = 'S0l1c1t4x1#2013';
