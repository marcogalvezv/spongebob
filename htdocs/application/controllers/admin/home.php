...
class Home extends Membership {
	...
	function __construct()
	{
        ...
        //$this->load->model('pageviewsmodel', 'mpageviews');
        $this->load->model('usermodel', 'muser');
        //$this->load->model('private_messagemodel', 'mprivate_message');
...
//		$this->load->view('admin/home/view',compact('stats_home'));
	}
