...
//			}
//
//			$userlogged = $this->user->login_check($user);
//            //admin login check
//			if($userlogged && $userlogged->gid == 1)
//            {
...
//                }
                $success = TRUE;
                $redirectTo = empty($userlogged->group->homepage) ? base_url() + "admin/dashboard" : $userlogged->group->homepage  ;
