            ...
            <form id="users-form" class="mws-form" action="form_elements.html">
                ...
                <div class="mws-form-inline">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <div id="filelistclientimage"></div>
                            <input id="clientpickfiles_" onclick="javascript:;"
                                   value="<?= lang('dialog.selectfile');?>"
                                   type="button"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

                            <input id="clientuploadfiles" onclick="javascript:;"
                                   value="<?= lang('dialog.uploadfile');?>" type="button"/>

                            <input type="hidden" name="profile[avatar]" id="clientadmin"
                    ...
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <div id="imgContentsClientAdmin"><?php if (isset($profile->avatar)) echo "<img src='"
                                .$profile->avatar . "' border='0' /><br /><a href='javascript:void(0);'
                                id='deleteThumbsClientAdmin' title='" . lang('dialog.delete') . "'>(" . lang('dialog
                                .delete')
                                . ")</a>";?></div>
                        </div>
                    </div>
                ...
                <div class="mws-panel grid_7">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table" id="t_address">
                            <thead>
                            <tr>
                    ...
                    <footer style="height:40px">
                        <div class="mws-button-row">
                            <input onclick="v_userprofile_editdriver()" value="<?= lang('users.tab.add');?>" type="button"
                                   class="btn"/>
...
<script type="text/javascript">
    ...
    var pluploader = new plupload.Uploader({
        ...
        browse_button:'clientpickfiles_',
        max_file_size:'10mb',
    ...
    pluploader.bind('FilesAdded', function (up, files) {
        for (var i in files) {
            document.getElementById("filelistclientimage").innerHTML = '<div id="' + files[i].id + '">' + files[i].name
    ...
    pluploader.bind('FileUploaded', function (up, file, objresponse) {
        ...
        var newinput = "<img src='" + path + "temp/user/" + file.name + "' alt='" + file.name + "' />" + "<a " +
                ...
                "(0);' id='deleteThumbsClientAdmin' title='<?=lang('dialog.delete')?>'>(<?=lang('dialog.delete')?>)) </a>";

        document.getElementById("imgContentsClientAdmin").innerHTML = newinput;
        document.getElementById("clientadmin").value = "/temp/user/" + file.name;
        document.getElementsByName('profile[avatar]').value = "/temp/user/" + file.name;
    });


    document.getElementById("clientuploadfiles").onclick = function () {
        pluploader.start();
        return false;
    };
