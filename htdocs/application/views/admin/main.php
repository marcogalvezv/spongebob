...
<script src="<?= base_url()?>js/admin/libs/jquery.mousewheel.min.js"></script>
...
<script src="<?= base_url()?>js/admin/jui/jquery-ui-1.9.2.min.js"></script>
<script src="<?= base_url()?>js/admin/jui/jquery-ui.custom.min.js"></script>
<script src="<?= base_url()?>js/admin/jui/jquery.ui.touch-punch.js"></script>

<!-- Plugin Scripts -->
<script src="<?= base_url()?>js/admin/plugins/datatables/jquery.dataTables.min.js"></script>
<!--[if lt IE 9]>
<script src="<?= base_url()?>js/admin/libs/excanvas.min.js"></script>
<![endif]-->
<script src="<?= base_url()?>js/admin/plugins/flot/jquery.flot.min.js"></script>
<script src="<?= base_url()?>js/admin/plugins/flot/plugins/jquery.flot.tooltip.min.js"></script>
<script src="<?= base_url()?>js/admin/plugins/flot/plugins/jquery.flot.pie.min.js"></script>
<script src="<?= base_url()?>js/admin/plugins/flot/plugins/jquery.flot.stack.min.js"></script>
<script src="<?= base_url()?>js/admin/plugins/flot/plugins/jquery.flot.resize.min.js"></script>
<script src="<?= base_url()?>js/admin/plugins/colorpicker/colorpicker-min.js"></script>
<script src="<?= base_url()?>js/admin/plugins/validate/jquery.validate-min.js"></script>
<script src="<?= base_url()?>js/admin/custom-plugins/wizard/wizard.min.js"></script>

<!-- Core Script -->
<script src="<?= base_url()?>js/admin/bootstrap.min.js"></script>
<script src="<?= base_url()?>js/admin/core/mws.js"></script>

<!-- Themer Script (Remove if not needed) -->
<script src="<?= base_url()?>js/admin/core/themer.js"></script>

<!-- Demo Scripts (remove if not needed) -->
<script src="<?= base_url()?>js/admin/demo/demo.dashboard.js"></script>
